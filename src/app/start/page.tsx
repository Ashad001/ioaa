/**
 * The workspace front screen — sign-in for a visitor, the new-run intake once
 * signed in. It used to live at `/`; the cinematic scroll page owns that address
 * now, so every "start a run" link and every signed-out redirect lands here.
 */
