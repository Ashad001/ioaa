/**
 * "Scroll Tied Video Section" — a standalone cinematic one-page scene.
 *
 * Deliberately outside the app shell: no rack header, no nav rail, no tokens from
 * the workspace palette. It is its own site, and the only thing it shares with the
 * rest of the project is the runtime.
 *
